...
```{r}
trimImages(path = "./figures", pattern = c(".png$"))
```
...
```{r, echo=FALSE, eval=FALSE}
# Read in data
#redwood <- read.table("/Users/olekristianskogly/Documents/Romlig stat/Project2/redwood.dat",  col.names = c("x", "y"))
redwood <- read.table("/Users/olekristianskogly/Documents/Romlig stat/Project2/redwood.dat",col.names = c("x", "y"), sep = " ", header = TRUE)
# Plot the data
plot(redwood)
...
L_sims_upper <- apply((Lsimulations), 2, quantile, 0.95)

L_sims_lower <- apply((Lsimulations), 2, quantile, 0.05)

#L-function with empirical prediction interval from guestimated model
...
```{r, echo=FALSE, eval=FALSE}
# Read in data
#cells <- read.table("/Users/olekristianskogly/Documents/Romlig stat/Project2/cells.dat",  col.names = c("x", "y"))
cells <- read.table("/Users/olekristianskogly/Documents/Romlig stat/Project2/cells.dat",col.names = c("x", "y"), sep = " ", header = TRUE)
# Plot the data
plot(cells)
